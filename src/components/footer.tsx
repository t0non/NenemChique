...
export function Footer() {
  ...
  return (
    <footer className="bg-white border-t border-primary/5 py-12 md:py-24">
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-10">
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-5">
              ...
              <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="p-3 bg-primary/5 rounded-2xl text-primary hover:bg-primary hover:text-white transition-all shadow-sm track-btn-whatsapp" data-gtm="whatsapp">
        ...
        <div className="mt-10 md:mt-20 pt-8 md:pt-10 border-t border-primary/5 text-center">
